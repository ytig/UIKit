package com.vdian.uikit.view.extend.salon;
...
public abstract class SalonMaster extends SalonView {
    ...
    public SalonMaster(ViewGroup root) {
        ...
        mIndicator.setLayoutParams(new ViewGroup.LayoutParams(RelativeLayout.LayoutParams.MATCH_PARENT, RelativeLayout.LayoutParams.MATCH_PARENT));
        addView(mIndicator); //添加页号
        mPopup = new SalonPopup(root.getContext());
        mPopup.setLayoutParams(new ViewGroup.LayoutParams(RelativeLayout.LayoutParams.MATCH_PARENT, RelativeLayout.LayoutParams.MATCH_PARENT));
        addView(mPopup); //添加弹窗
        setLayoutParams(new ViewGroup.LayoutParams(RelativeLayout.LayoutParams.MATCH_PARENT, RelativeLayout.LayoutParams.MATCH_PARENT));
        root.addView(this);
    }
    ...
    private static class SalonPopup extends LinearLayout implements TransitionController.TransitionListener, View.OnClickListener {
